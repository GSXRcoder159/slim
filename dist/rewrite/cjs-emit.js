...
export function isCjsConsumer(file, packageType) {
    if (file.endsWith(".cjs"))
        return true;
    if (file.endsWith(".js") && packageType !== "module")
        return true;
    return false;
}
export function emitCjsSource(ts, source, fileName) {
...
//# sourceMappingURL=cjs-emit.js.map