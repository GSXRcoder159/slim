...
function fillCustom(alphabet, size) {
...
export function nanoid(size = DEFAULT_SIZE) {
    ...
    if (n < 0) {
        ...
        throw new RangeError(`The value of "size" is out of range. It must be >= 0 && <= 9007199254740991. Received ${n << 7}`);
    }
    if (n === 0)
        return "";
    return fillUrl(n);
