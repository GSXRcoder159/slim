...
export function extractNpmPack(tarball, dest) {
...
export function contentDigestOfDir(root) {
...
export function npmContentDigest(tarball) {
...
export function stampActionSha256(packageRoot) {
    const stamp = readStamp(packageRoot);
    return stamp?.actionSha256 ?? null;
}
export function stampDistSha256(packageRoot) {
    const stamp = readStamp(packageRoot);
    return stamp?.sha256 ?? null;
}
export function readStamp(packageRoot) {
